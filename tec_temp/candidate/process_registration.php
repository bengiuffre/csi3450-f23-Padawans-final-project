...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Retrieve the current maximum existing candidate id, we then increment this by one for the next available candidate ID
    ...
    // Insert candidate input into the candidate table
    ...
    if (mysqli_query($conn, $insertCandidateQuery)) {
        // Insert job history into the job_history table
